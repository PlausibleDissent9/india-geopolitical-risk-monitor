...
Contract version 2.2.6, frozen 2026-08-08. Machine-readable API description: https://igrm.in/openapi.json
...
The API contract (data/api_contract.json, version 2.2.6, frozen 2026-08-08) lists 102 endpoints: 96 JSON, 5 CSV, 1 RSS. The machine-readable OpenAPI 3.1 description is served at https://igrm.in/openapi.json.
