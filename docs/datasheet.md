...
Contract version 2.6.0, frozen 2026-08-12. Machine-readable API description: https://igrm.in/openapi.json
...
The API contract (data/api_contract.json, version 2.6.0, frozen 2026-08-12) lists 120 endpoints: 114 JSON, 5 CSV, 1 RSS. The machine-readable OpenAPI 3.1 description is served at https://igrm.in/openapi.json.
