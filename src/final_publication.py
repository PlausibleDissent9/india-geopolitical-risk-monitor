    ...
    *,
    ...
    try:
        ...
        expected_bytes = {
            ...
            # Match write_public_status's pre-existing default-ASCII byte
            # convention exactly. Current status metadata includes Unicode
            # punctuation, so using _json_bytes(ensure_ascii=False) here
            # would refuse the publisher's own deterministic output.
            "docs/data/status.json": (
