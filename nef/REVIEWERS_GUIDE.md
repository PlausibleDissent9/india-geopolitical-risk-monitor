...
| The registered detector's episode results publish with their baselines | validation.html; `detection_baselines.json` | The corresponding-channel criterion records 24/29, versus 19/29 under strict-start timing, 26/29 for a naive any-channel detector and 6.8 expected by the published chance calculation. The original pre-registered tranche was 18/21; the later registered tranche was 6/8. Event names do not appear in query terms. |
