...
| Terms URL in registry | none registered |
...
1. GDELT's June/July 2026 Web NGrams v5 announcement describes the temporary
...
2. GDELT's 2022 Web NGrams 3.0 guidance recommends the downloadable dataset for
...
3. The production module records a 2026-07-28 maintainer response directing
...
These materials establish access and an intended analytical use case. **They
do not, on their face, provide an explicit license for IGRM to publish retained
article identifiers, titles, URLs, or a source-derived extract in a public Git
repository or audit bundle.** No packet author should convert "downloadable"
or "unlimited querying" into a redistribution grant.
...
Approval of only uses 1–2 does **not** unblock the current code. Approval of
uses 3–4 should not be recommended without an explicit provider permission,
applicable license text, or qualified rights review covering the retained
...
1. What exact terms or written permission cover analytical processing and
   publication of the derived daily score?
2. What exact terms or written permission cover public retention of hashed
   document identities plus matched title/URL/date metadata?
